...
- Valid run: **YES**
- Quality gate: **PASS**
- Mode: LLM=`dashscope`, embedding=`off`
- Cases: 5
...
| Required-variable coverage | 62.5% (n=1) |
| Citation provenance | 100.0% (5/5) |
| Mean / p95 latency | 3561.3 / 5295.8 ms |
...
| p95LatencyMs | ≤ 10000 | 5295.8 | PASS |

## Most common failures

- action.required_variables: 1
