const inferenceRules = [
  ...
  },
  {
    ...
    confidence: 0.82,
    isApproximation: true,
    pattern: /step-free|step free|no steps|avoid steps|avoid stairs|avoids stairs|avoid all stairs|avoids all stairs|without stairs|reduced mobility/i,
    ...
    matchedTerms: ["step-free", "step free", "no steps", "avoid steps", "avoid stairs", "avoids stairs", "avoid all stairs", "without stairs", "reduced mobility"],
