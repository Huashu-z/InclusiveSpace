...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: bq9LOnCioDwS/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__eYi4Z)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__hRzBi)}>
            <div
              className={classNames(
                projectcss.all,
