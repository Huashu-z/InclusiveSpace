...
import Button from "../../Button"; // plasmic-import: es9YdAeJ_HTY/component
...
import sty from "./PlasmicCtaBlock.module.css"; // plasmic-import: rAg7mntU2p-Z/css
import ArrowRightSvgIcon from "./icons/PlasmicIcon__ArrowRightSvg"; // plasmic-import: abPIbKksWClw/icon
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__iMbo)}>
            <h2
          ...
          <div className={classNames(projectcss.all, sty.column__dnKyv)}>
            <Button
