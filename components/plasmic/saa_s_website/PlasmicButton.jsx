...
import sty from "./PlasmicButton.module.css"; // plasmic-import: es9YdAeJ_HTY/css
import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: 0hXY__cBTkKA/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: SWMKlknz9t08/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__lnDen, {
          [sty.freeBoxcolor_neutral__lnDenvgwp]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__lnDen4KDj3L3Isr]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__lnDeNpLfgc]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__lnDenu047I]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__lnDenhytd6]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__lnDenfxaPr]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__lnDenRyLrG]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__lnDeNl3Isr]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___3N1SV, {
            [sty.freeBoxcolor_neutral___3N1SVvgwp]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft___3N1SVvgwpE9BOj]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart___3N1SV72TjI]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge___3N1SVu047I]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___3N1SVfxaPr]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___3N1SVRyLrG]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered___3N1SVl3Isr]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__mbhPz)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__rxh00, {
            [sty.freeBoxiconEnd__rxh00764X9]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__rxh00U047I]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__rxh00FxaPr]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__rxh00RyLrG]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__dqS9P)}
                role={"img"}
              />
            ),
