...
import MenuSection from "../../MenuSection"; // plasmic-import: u0aerLYCjy_n/component
...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: Zg4s2YlHaKET/css
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__dgOL)}
                    value={"item1"}
                  />
