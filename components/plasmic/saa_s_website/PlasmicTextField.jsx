...
import Label from "../../Label"; // plasmic-import: rRHa6sutWAMk/component
import TextInput from "../../TextInput"; // plasmic-import: 6QUK1TKxC8e0/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: sk8UU7NZ0haD/component
import Description from "../../Description"; // plasmic-import: DvIi7D0cOleK/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: 7dwSa8bPVtQ1/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__mx1Yj, {
          [sty.freeBoxiconEnd__mx1YjpM4Kn]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__mx1YjSOxeL]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__mx1YjoMz8S]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__hzbzz, {
            [sty.freeBoxiconStart__hzbzzSOxeL]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__hzbzzoMz8S]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__ovRnV)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___2RlBb, {
            [sty.freeBoxiconEnd___2RlBbpM4Kn]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___2RlBbSOxeL]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___9PrkI)}
                role={"img"}
              />
            ),
